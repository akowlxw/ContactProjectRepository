...
namespace ContactProjectTests
{
    ...
    public class ContactManagerTests
    {
        ...
        [TestMethod]
        public void AddContact_Successfully()
        {
            var manager = new ContactManager();
        ...
        [TestMethod]
        public void RemoveContact_Successfully()
        {
            var manager = new ContactManager();
            var contact = new Contact("Тест", "+79891234567");
            manager.AddContact(contact);
        ...
        {
            var manager = new ContactManager();
            manager.AddContact(new Contact("Иван", "+79991111111"));
            manager.AddContact(new Contact("Мария", "+79992222222"));
